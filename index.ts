...
function countdown_timer(target_date: DateTime): void {
    ...
    console.log(
       `Time remaining: ${time_difference.days} days, ${time_difference.hours} hours, ${time_difference.minutes} minutes, and ${time_difference.seconds} seconds.`
    );
